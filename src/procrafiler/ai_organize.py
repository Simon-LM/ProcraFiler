...
def _build_organize_prompt(
    ...
    return (
        ...
        "- Only a one-off AFFAIR/event folder is dated. A SERIES folder (recurring kind) is NEVER "
        "dated — it is open-ended (e.g. \".../Housing/Releves-eau\"); a period inside a series is a "
        "bare-YEAR subfolder (e.g. \"Releves-eau/2026\").\n"
