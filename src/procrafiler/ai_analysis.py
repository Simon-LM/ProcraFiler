...
def _build_analysis_prompt(
    ...
    return (
        ...
        "  SOCIAL-MEDIA / ONLINE CONTENT: avatars, profile pictures, memes, thumbnails, screenshots of "
        "social posts or chats, and the user's own videos/posts/streams belong under "
        "\"Personal/Reseaux-sociaux\" (a real subject — NOT a hobby like Musique, and not Divers) — "
        "UNLESS such content is clearly the user's declared JOB or business, in which case it is Work. "
        "This is what keeps an avatar or a video out of an unrelated hobby folder.\n"
