...
def _build_analysis_prompt(
    ...
    return (
        ...
        "  DATES IN FOLDER NAMES: a SERIES folder is NEVER dated — it is open-ended; when a period "
        "grouping helps (several years, many files), use a bare-YEAR subfolder INSIDE it (e.g. "
        "\".../Energy/Factures-electricite/2026\"). Only a one-off AFFAIR/event folder carries a "
        "date, placed at the START of its name (e.g. \".../Housing/2025-08_Degats-eaux-cuisine\"), "
        "never at the end.\n"
